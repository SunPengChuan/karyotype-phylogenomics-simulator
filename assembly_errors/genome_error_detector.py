  ...
  1. Misassembly  — a foreign gene block inserted into a target chromosome.
     Three detection methods:
       ...
       SANDWICH : minority root-chromosome genes flanked by majority genes,
                  with four filters (WGD, ancestor, NCF, compound-block)
...
def main():
    ...
    parser.add_argument('--ancestors', default='output_reconstruction_misassembled/ancestor_gene_sets_by_node.tsv',
        help='Reconstructed ancestor gene sets TSV (default: %(default)s)')
    parser.add_argument('--species', default='output_simulator/karyotypes_misassembled.txt',
