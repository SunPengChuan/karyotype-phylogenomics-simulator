...
# 3. Generate root comparison dot plot (optional)
python plot_root_comparison.py
...
| `plot_root_comparison.py` | Generate dot plot comparing reconstructed vs true root karyotype |
...
| `DotPlot_ReconstructedRoot_vs_TrueRoot.png` | Comparison of reconstructed vs true root (generated by `plot_root_comparison.py`) |
