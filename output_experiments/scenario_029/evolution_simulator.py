...
CONFIG = dict(
    ...
    rearrangement_counts=dict(
        inversion_prob=0.506,   # Probability of inversion per branch (0-1)
        translocation_rct=0.236,  # Probability of RCT per branch (0-1)
        fusion_ncf=0.339,       # Reduced to 0.2 (20% chance per branch)
        fusion_eej=0.75,       # Reduced to 0.3 (30% chance per branch)
    ),
