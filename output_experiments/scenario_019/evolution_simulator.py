...
CONFIG = dict(
    ...
    rearrangement_counts=dict(
        inversion_prob=0.86,   # Probability of inversion per branch (0-1)
        translocation_rct=0.37,  # Probability of RCT per branch (0-1)
        fusion_ncf=0.554,       # Reduced to 0.2 (20% chance per branch)
        fusion_eej=0.796,       # Reduced to 0.3 (30% chance per branch)
    ),
    rct_pairing_mode="random",
    eej_end_mode="random",
    
    # Whole Genome Duplication (WGD)
    wgd_probability=0.141,     # Reduced from 0.1
