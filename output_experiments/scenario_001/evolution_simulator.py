...
CONFIG = dict(
    ...
    # Karyotype settings
    num_ancestor_chromosomes=10,  # A-P
    ...
    rearrangement_counts=dict(
        inversion_prob=0.628,   # Probability of inversion per branch (0-1)
        translocation_rct=0.277,  # Probability of RCT per branch (0-1)
        fusion_ncf=0.373,       # Reduced to 0.2 (20% chance per branch)
        fusion_eej=0.203,       # Reduced to 0.3 (30% chance per branch)
    ),
    rct_pairing_mode="random",
    eej_end_mode="random",
    
    # Whole Genome Duplication (WGD)
    wgd_probability=0.14,     # Reduced from 0.1
