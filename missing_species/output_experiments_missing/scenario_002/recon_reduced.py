...
# -----------------------------
CONFIG = dict(
    input_tree="output_simulator_reduced/tree.nwk",
    input_karyotypes="output_simulator_reduced/karyotypes_species_with_outgroup.txt",
    input_true_root_karyotype="output_simulator_reduced/karyotypes_true_root.txt",
    output_dir="output_reconstruction_reduced",
    tree_viz_output_dir="output_simulator_reduced",
